...
public class SetLowerHeight extends PIDCommand {
	...
	private boolean arbitraryAngle = false;
	boolean goUp;
	double lastHeight = 0;
	...
	public SetLowerHeight(double angle) {
		super(0.2, 0.0, 0.0);
		requires(RobotMap.lowerLifter);
		goUp = true;
		arbitraryAngle = true;
	...
	protected void initialize() {
		...
		if (arbitraryAngle || (RobotMap.upperLifter.MIN_ANGLE + 20) < RobotMap.upperLifter.getHeight()) {
			bailOut = false;
